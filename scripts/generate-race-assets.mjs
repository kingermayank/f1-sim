...
const teams = [
  ['mercedes', '#00A19C', '#C8CCCE'], ['ferrari', '#E80020', '#FFF200'],
  ['mclaren', '#FF8000', '#47C7FC'], ['red-bull', '#3671C6', '#FCD700'],
  ['racing-bulls', '#6692FF', '#FFFFFF'], ['alpine', '#FF87BC', '#2293D1'],
  ['haas', '#B6BABD', '#E6002D'], ['audi', '#F50537', '#B7FF00'],
  ['williams', '#1868DB', '#00A0DE'], ['aston-martin', '#229971', '#CEDC00'],
  ['cadillac', '#C8A96B', '#111111'],
];

function createLiverySvg(base, accent, index) {
  ...
  <text x="256" y="282" text-anchor="middle" fill="#fff" font-family="Arial, sans-serif" font-size="42" font-weight="700" letter-spacing="5">ASSET ${String(index + 1).padStart(2, '0')}</text>
  <text x="256" y="472" text-anchor="middle" fill="#fff" font-family="Arial, sans-serif" font-size="18" font-weight="700" letter-spacing="5">RACE // 26</text>
  </svg>`;
}
...
async function writeLiveryTextures() {
  ...
  try {
    for (const [index, [team, base, accent]] of teams.entries()) {
      const svg = createLiverySvg(base, accent, index);
