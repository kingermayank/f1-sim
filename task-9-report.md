...
- Pit presentation derives continuous, monotonic spline progress from authoritative track distance and pit state, then interpolates transforms between snapshots.
